...
\begin{figure}[H]
	\centering
	\itshape
	\includegraphics[width=15cm,height=7cm]{avecsans.png}
...
\begin{figure}[H]
	\centering
	\itshape
	\includegraphics[width=10cm,height=7cm]{articlefin.png}
...
\begin{figure}[H]
	\centering
	\itshape
	\includegraphics[width=15cm,height=8cm]{options_simu_1.PNG}
