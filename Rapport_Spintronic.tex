...
%----------------------------------------------------------------------------------------
\begingroup
\noindent \hspace{15cm}\textsc{08/03/2017}
\begin{figure}[H]
	\hspace*{14.55cm}
	\centering
	\itshape
	\includegraphics[width=3cm,height=3cm]{TB_contour_quadri.jpg}
\end{figure}
\thispagestyle{empty}
...
\begin{tikzpicture}[remember picture,overlay]
  ...
  {\begin{tikzpicture}[remember picture,overlay]
      ...
      \draw[anchor=north] (midpoint) node [fill=blue1!20!white,fill opacity=0.2,text opacity=1,inner sep=1cm]{\Huge\centering\bfseries\sffamily\parbox[c][][t]{\paperwidth}{\Huge\centering \textsf{Rapport de Projet S5} \\[0pt] % Book title
      {\Large Département micro-ondes de Télécom-Bretagne}\\[20pt] 
      {\Huge Etude d'un filtre configurable basé sur l'utilisation de matériaux issus de la spintronic\\[20pt]
      {\Large\centering Rodolphe JEUNEHOMME\\[40pt]
      {\begin{figure}[H]
	\hspace*{6cm}
	\centering
	\itshape
	\includegraphics[width=8cm,height=5cm]{SSR_YIG14.png}
      \end{figure}}}}}};
...
\begin{figure}[H]
	\centering
	\itshape
	\includegraphics[width=13cm,height=7cm]{introspin.png}
...
\begin{figure}[H]
	\centering
	\itshape
	\includegraphics[width=3.5cm,height=5cm]{simplestub.png}
...
~\\\\La surface maximum en champs magnétique c'est à dire celle ou le couplage entre le YIG et le résonateur électrique sera le plus fort est située à hauteur de $\frac{\lambda}{4}$ (par rapport à la résonance) à la moitié du tronçon de ligne simple STUB de longueur $\frac{\lambda}{2}$ comme illustré sur la figure~\underline{\color{blue}\ref{elec}} suivante:

\begin{figure}[H]
	\centering
	\itshape
	\includegraphics[width=13cm,height=5.5cm]{elec.png}
...
\begin{figure}[H]
	\centering
	\itshape
	\includegraphics[width=15cm,height=7cm]{f02.png}
	\caption{\label{fo} \underline{Résonance électrique}}
\end{figure}
\noindent\footnotesize  \textbf{Figure~\underline{\color{blue}\ref{fo}} | Droite: avec YIG/Pt, }le paramètre $ fo\simeq4.736\ GHz$ correspond à la fréquence à laquelle le filtre coupe-bande à simple STUB ne laisse plus passer le signal. \textbf{Gauche: sans YIG/Pt, }il y a un décalage de la résonance d'environ 200 MHz vers les fréquences plus faibles.
~\\\\
...
\begin{figure}[H]
	\centering
	\itshape
	\includegraphics[width=13cm,height=8cm]{matH.png}
...
\begin{figure}[H]
	\centering
	\itshape
	\includegraphics[width=10cm,height=7cm]{dch.png}
...
~\\\\Il s'agira donc de réadapter le design utilisé pour la conception du résonateur électrique à simple STUB, sur un substrat \emph{ROGERS} de permitivité 4.15, pour concevoir le design d'un circuit multicouches intégrant le résonateur électrique à simple STUB, la cavité pour contenir le YIG et les \emph{pads} de connexions pour contrôler et mesurer le comportement du filtre.
...
\begin{figure}[H]
	\centering
	\itshape
	\includegraphics[width=15cm,height=5cm]{material_substrat.PNG}
	\caption{\label{substrat} \underline{Propriétés substrat LTCC}}
\end{figure}
\noindent La permitivité du substrat est de 4.5 et les pertes magnétiques sont de $18*10^{-3}$ et son épaisseur est de  $500*10^{-6}\ m$. Plus la permitivité est grande et plus ???.
\section{Le résonateur électrique à simple STUB}
...
\begin{figure}[H]
	\centering
	\itshape
	\includegraphics[width=10cm,height=5cm]{layout_stub.PNG}
...
\begin{figure}[H]
	\centering
	\itshape
	\includegraphics[width=12cm,height=8cm]{simu_stub.PNG}
...
\begin{figure}[H]
	\centering
	\itshape
	\includegraphics[width=15cm,height=5cm]{multicouches.png}
...
\begin{figure}[H]
	\centering
	\itshape
	\includegraphics[width=10cm,height=7cm]{layout_final.PNG}
...
\begin{figure}[H]
	\centering
	\itshape
	\includegraphics[width=15cm,height=10cm]{options_simu_1.PNG}
	\caption{\label{opt1} \underline{Options Simulation - Frequency Plan}}
\end{figure}
\begin{figure}[H]
	\centering
	\itshape
	\includegraphics[width=15cm,height=10cm]{options_simu_2.PNG}
	\caption{\label{opt2} \underline{Options Simulation - Preprocessor}}
\end{figure}
\begin{figure}[H]
	\centering
	\itshape
	\includegraphics[width=15cm,height=10cm]{options_simu_3.PNG}
